...
export default function Testimonials() {
  const reviews: Testimonial[] = [
    ...
    },
    {
      ...
      metricValue: "5/5",
      avatar: "", // Simulating missing avatar path to trigger the custom fallback icon
    },
    {
      quote:
    ...
    <section className="max-w-7xl mx-auto px-[6px] px-[12px] bg-white py-12 sm:py-20 select-none border-t border-zinc-100">
      ...
      <div className="">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div>
            <h2 className="text-3xl md:text-5xl font-medium tracking-tight text-zinc-950 mt-1">
              What Partners Say
            </h2>
            <h2 className="text-3xl md:text-5xl font-medium tracking-tight text-zinc-950 mt-1">
              About Us
      ...
      <div className="relative w-7xl mx-auto overflow-hidden flex mask-gradient-container group">
        ...
        <div className="animate-marquee flex gap-6 pr-6 hover:[animation-play-state:paused]">
          {[...reviews, ...reviews, ...reviews].map((item, idx) => (
            <div
              key={idx}
              className="relative flex flex-col justify-between p-6 bg-zinc-50/50 hover:bg-white border border-zinc-200/60 hover:border-[#4DB2E0]/40 rounded-2xl shadow-xs hover:shadow-xl transition-all duration-300 ease-out w-75 sm:w-95 shrink-0"
            >
              <div>
                {/* Top Accent Elements */}
              ...
              <div className="pt-5 border-t border-zinc-200/60 mt-auto">
                {/* Metric Overlay Card */}
                <div className="mb-4 flex items-center justify-between bg-white border border-zinc-100 px-3 py-2 rounded-xl transition-colors shadow-2xs">
                ...
                <div className="flex items-center gap-3">
                  <div className="relative w-9 h-9 overflow-hidden rounded-full border border-zinc-200 shrink-0 bg-zinc-100 flex items-center justify-center">
