...
const portfolioShowcase = [
  {
    ...
    description:
      "Professional websites built to grow your brand, attract clients, and turn visitors into real customers.",
  },
  {
    num: "02",
    tag: "PORTFOLIO",
    ...
    description:
      "Clean and modern portfolio websites that showcase your work, skills, and projects in the best way possible.",
  },
  {
    num: "03",
    tag: "E-COMMERCE",
    ...
    description:
      "Fast and responsive online stores with smooth shopping experiences, secure payments, and easy product management.",
  },
  {
    num: "04",
    tag: "DESIGN",
    ...
    description:
      "Give your old website a modern upgrade with better visuals, improved performance, and a cleaner user experience.",
  },
];
...
function DynamicWebsite() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-foreground text-[#18181B] flex flex-col justify-center py-12 sm:py-24 px-4 sm:px-8 lg:px-12 overflow-hidden selection:bg-[#18181B] selection:text-[#f5f5f0]">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col">
        {portfolioShowcase.map((card, index) => {
          ...
          return (
            <div
              ...
              onClick={() => setHoveredIdx(isHovered ? null : index)} // Clean tap toggle container target for mobile viewports
