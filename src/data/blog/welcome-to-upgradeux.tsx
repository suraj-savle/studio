  ...
  content: (
    <>
      ...
      <div className="bg-zinc-50 border border-zinc-200 rounded-xl p-6 my-8">
        <h3 className="font-bold text-sm sm:text-lg mb-3">Our Mission</h3>
      ...
      <h2 className="text-xl sm:text-2xl font-medium my-2">What We Do ?</h2>

      <p className="text-sm sm:text-lg my-2">
      ...
      <h2 className="text-xl sm:text-2xl font-medium my-4">Our Approach</h2>
